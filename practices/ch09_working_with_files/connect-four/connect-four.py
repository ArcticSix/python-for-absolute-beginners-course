...
def main():
    ...
    tokens = [input(f"{players[0]}, what is your symbol? "),
              input(f"{players[1]}, what is your symbol? ")]
...
def show_title():
    print()
    print("---------------------------------")
    print("-        CONNECT FOUR V2        -")
    print("-    Now with leader boards!    -")
    print("-    Also with symbol choice!   -")
    print("---------------------------------")
    print()
